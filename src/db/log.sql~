...
CREATE TABLE IF NOT EXISTS `mydb`.`DadosFinanceiros` (
  ...
  `rendaFamiliar` DECIMAL NULL,
  `rendaPessoal` DECIMAL NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`StatusContrato`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`StatusContrato` (
  `idStatusContrato` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`planoEmprestimo` (
  ...
  `jurosTotal` DECIMAL NULL,
  `jurosMensal` DECIMAL NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Contrato` (
  ...
  `valorEmprestimo` DECIMAL NULL,
  `valorParcelas` DECIMAL NULL,
  ...
  INDEX `fk_Contrato_StatusContrato1_idx` (`idStatusContrato` ASC),
  ...
  CONSTRAINT `fk_Contrato_Cliente1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Contrato_StatusContrato1`
    FOREIGN KEY (`idStatusContrato`)
    REFERENCES `mydb`.`StatusContrato` (`idStatusContrato`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
